        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://pagead2.googlesyndication.com https://www.google-analytics.com https://*.adtrafficquality.google https://*.doubleclick.net https://*.supabase.co wss://*.supabase.co https://api.stripe.com",
            ].join("; "),
          },
        ],
      },
